 ...
 *
 * Env: OPENAI_API_KEY (required), OPENAI_BASE_URL (optional), DOC_FROM_USAGE_MODEL (optional)
 */
...
function printHelp() {
  console.log(`
Documate CLI – Record usage and generate docs from Screenpipe + OpenAI (no web UI).
